...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:param name="heuristic-character-replacement-tokens" select="()" as="xs:string*"/>
  ...
  <xsl:function name="mml:get-color" as="attribute()?">
    ...
    <xsl:variable name="applied-color-value" as="xs:string?" 
                  select="string(($color-value[last()])[1])"/>
    <xsl:choose>
      <xsl:when test="$mml-version eq '4-core' and $applied-color-value">
        <xsl:attribute name="css:color" select="$applied-color-value"/>
      </xsl:when>
      <xsl:when test="$applied-color-value">
        <xsl:attribute name="mathcolor" select="$applied-color-value"/>
      </xsl:when>
    </xsl:choose>
  </xsl:function>
  ...
  <xsl:function name="mml:get-background-color" as="attribute()?">
    ...
    <xsl:choose>
      ...
      <xsl:when test="$applied-color-value">
        <xsl:attribute name="mathbackground" select="$applied-color-value"/>
      </xsl:when>
    </xsl:choose>
  </xsl:function>
